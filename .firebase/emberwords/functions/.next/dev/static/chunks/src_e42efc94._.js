...
"[project]/src/app/card/[id]/memory/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function MemoryPage({ params }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MemoryPage.useEffect": ()=>{
            const loadCard = {
                "MemoryPage.useEffect.loadCard": async ()=>{
                    const wordCard = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$wordService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWordById"])(id);
                    setCard(wordCard);
                    setLoading(false);
                }
            }["MemoryPage.useEffect.loadCard"];
            loadCard();
        }
    }["MemoryPage.useEffect"], [
        id
...
_s(MemoryPage, "0FYAERLkYRSV9grKruRC6KyKwUk=", false, function() {
    return [
...
__turbopack_context__.k.register(_c2, "MemoryPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_e42efc94._.js.map